<template>
  <div id="tags-view-container" class="tags-view-container">
    ...
    <ul v-show="visible" :style="{left:left+'px',top:top+'px'}" class="contextmenu">
      ...
      <li v-if="!isAffix(selectedTag)" @click="closeSelectedTag(selectedTag)"><i class="el-icon-close" /> 关闭</li>
      ...
      <li @click="closeAllTags(selectedTag)"><i class="el-icon-circle-close" /> 关闭全部</li>
    </ul>
  </div>
</template>
  ...
  methods: {
    ...
    toLastView(visitedViews, view) {
      ...
      if (latestView) {
        ...
        // 如果没有标签视图，默认情况下会重定向到主页。你可以根据需要调整
